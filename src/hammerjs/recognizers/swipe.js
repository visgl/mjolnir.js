...
import { DIRECTION_HORIZONTAL,DIRECTION_VERTICAL } from '../input/input-consts';
import PanRecognizer from './pan';
import { INPUT_END } from '../input/input-consts';
...
export default class SwipeRecognizer extends AttrRecognizer {
  ...
  attrTest(input) {
    ...
    return super.attrTest(input) &&
        ...
        Math.abs(velocity) > this.options.velocity && input.eventType & INPUT_END;
  }
